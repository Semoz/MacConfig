...
SOURCE_PATH=$HOME"/_FileData/Downloads/Baidu"
link_data_path "$SOURCE_PATH" "$DESTINATION_PATH"

# Link Opera Download
DESTINATION_PATH=$HOME"/Downloads/Opera"
SOURCE_PATH=$HOME"/_FileData/Downloads/Opera"
link_data_path "$SOURCE_PATH" "$DESTINATION_PATH"

# Link PPHelper Download
# DESTINATION_PATH=$HOME"/Downloads/PP 下载"
# SOURCE_PATH=$HOME"/_FileData/Downloads/PPHelper"
# link_data_path "$SOURCE_PATH" "$DESTINATION_PATH"

# Link QQ Download
DESTINATION_PATH=$HOME"/Downloads/QQ"
SOURCE_PATH=$HOME"/_FileData/Downloads/QQ"
link_data_path "$SOURCE_PATH" "$DESTINATION_PATH"

# Link Thunder Download
DESTINATION_PATH=$HOME"/Downloads/Thunder"
SOURCE_PATH=$HOME"/_FileData/Downloads/Thunder"
link_data_path "$SOURCE_PATH" "$DESTINATION_PATH"